...
namespace Config {
    namespace Test3 {
        ...
        namespace Styles {
            ...
            // 电梯内部楼层按钮样式 (Sidebar) - 金属质感高对比度
            constexpr const char* STYLE_BTN_ELEVATOR_FLOOR = "background-color: #BDC3C7; color: black; border: 2px solid #7F8C8D; border-radius: 4px; font-weight: bold; font-size: 18px;";
